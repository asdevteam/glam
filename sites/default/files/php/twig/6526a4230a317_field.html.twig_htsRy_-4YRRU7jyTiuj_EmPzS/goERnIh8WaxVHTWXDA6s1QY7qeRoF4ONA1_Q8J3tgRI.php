...
/* themes/oshop/templates/field.html.twig */
class __TwigTemplate_ab48cd6990d05e2d496b83bc940e6efa extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        if ((($context["field_name"] ?? null) == "field_tag")) {
            // line 2
...
($context["field_name"] ?? null) == "field_category")) {
            // line 6
            echo "
";
            // line 7
    ...
    ";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, true, 9) == false)) {
                    echo " /  ";
                }
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, true, 14) == false)) {
                    echo " ,  ";
                }
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
    ...
    {
        return "themes/oshop/templates/field.html.twig";
    }
    ...
    {
        return array (  117 => 14,  100 => 13,  96 => 11,  79 => 9,  76 => 8,  59 => 7,  56 => 6,  54 => 5,  45 => 3,  41 => 2,  39 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% if field_name == 'field_tag' %}
{% for item in items %}
   <li> {{ item.content }} </li>
{% endfor %}
{% elseif field_name == 'field_category' %}

{% for item in items %}

    {{ item.content }}{% if loop.last == false %} /  {% endif %}
{% endfor %}
...
{% for item in items %}
    {{ item.content }}{% if loop.last == false %} ,  {% endif %}
{% endfor %}
{% endif %}", "themes/oshop/templates/field.html.twig", "/var/www/html/themes/oshop/templates/field.html.twig");
    }
