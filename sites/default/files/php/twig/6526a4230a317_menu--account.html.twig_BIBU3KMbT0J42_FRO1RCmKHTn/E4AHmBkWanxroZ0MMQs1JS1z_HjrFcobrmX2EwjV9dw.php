...
/* themes/oshop/templates/menu--account.html.twig */
class __TwigTemplate_1008c395d4c33fc7bd7ab0548df2c683 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 35
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "topbar-menu"], "method", false, false, true, 35), 35, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 37
  ...
  ";
    ...
    {
        return "themes/oshop/templates/menu--account.html.twig";
    }
    ...
    {
        return array (  116 => 47,  109 => 45,  103 => 43,  101 => 42,  95 => 41,  90 => 40,  85 => 39,  81 => 37,  75 => 35,  72 => 34,  69 => 33,  66 => 32,  51 => 31,  44 => 29,  41 => 24,  39 => 23,);
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('topbar-menu') }}>
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
  ...
  {% endif %}
{% endmacro %}", "themes/oshop/templates/menu--account.html.twig", "/var/www/html/themes/oshop/templates/menu--account.html.twig");
    }
