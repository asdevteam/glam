...
! function (e) {
	function t(t) {
		var r = {};
		var lat = $('.structural_map').data('lat');
  		var lng = $('.structural_map').data('lag');
  		var location_map ='0.0,0.0';
		return r.coords = location_map , r.address = e(t).attr("data-address"), r.marker = e(t).attr("data-marker"), r["marker-pos"] = e(t).attr("data-marker-pos"), r["marker-pos-top"] = e(t).attr("data-marker-pos-top"), r["marker-pos-left"] = e(t).attr("data-marker-pos-left"), r.skin = e(t).attr("data-skin"), r.zoom = e(t).attr("data-zoom"), isEmpty(r.zoom) && (r.zoom = 12), isEmpty(r["marker-pos-top"]) && (r["marker-pos-top"] = 0), isEmpty(r["marker-pos-left"]) && (r["marker-pos-left"] = 0), r
	}
