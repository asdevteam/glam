...
class MDSliderController extends ControllerBase {
  ...
  public function listMDSlider() {
    ...
    return array(
      ...
      '#header' => $header,
      '#rows' => $rows,
      '#empty' => t('No MegaSlider available. <a href="@link">Add MegaSlider</a>.', array('@link' => Url::fromRoute('md_slider.admin.add')->toString())),
  ...
  public function editMDSlider($slider) {
    ...
    // changed
    $json_url = Url::fromRoute('md_slider.admin.json_response', [], ['absolute' => TRUE])->toString();
    $html_url = Url::fromRoute('md_slider.admin.html_response', [], ['absolute' => TRUE])->toString();
    $image_url = Url::fromRoute('md_slider.admin.image', [], ['absolute' => TRUE])->toString();
